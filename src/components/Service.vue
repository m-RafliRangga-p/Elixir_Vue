<template>
    <!-- SERVICES -->
    <section id="services-1" class="mt-5 mb-4">
        <div class="container">
            <div class="row">
            ...
            <div class="row g-4 text-center">
                <div class="col-lg-4 col-sm-6"data-aos="fade-down" data-aos-delay="150">
                    <div class="service theme-shadow p-lg-5 p-4">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Magnam quae possimus enim.</p>
                    </div>
                </div>
    ...
    <section id="services-2" class="section-padding border-top">
        <div class="container">
            <div class="row">
                <div class="col-12 text-center" data-aos="fade-down" data-aos-delay="150">
                    <div class="section-title">
    ...
    <!-- COUNTER -->
    <section id="counter" class="section-padding mb-5">
